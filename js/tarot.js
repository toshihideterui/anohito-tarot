...
function getCardMessage(card, isReversed) {
  ...
  const fallbackMessages = [
    'カードは静かに答えを示しています。今は焦らず、相手の小さな変化に目を向けてみてください。',
    '月明かりのように、あの人の気持ちは少しずつ見えてきます。やさしく待つことが鍵です。',
    '今は言葉より空気に答えが宿ります。相手の態度の中に、次のヒントが隠れています。',
  ];
  const source = msgs && msgs.length ? msgs : fallbackMessages;
